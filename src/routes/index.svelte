...
<div class="w-5/6 md:w-1/2 flex flex-col justify-center items-center">
    <div class="text-black dark:text-white">
        number of words: 
        <button on:click={decrementNumberOfWords}>-</button>
         {numberOfWords} 
        <button on:click={incrementNumberOfWords}>+</button>
    </div>
